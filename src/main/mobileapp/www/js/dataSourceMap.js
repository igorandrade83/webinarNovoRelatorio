...
window.dataSourceMap["app.Endereco"] = { customId: "app.entity.Endereco", serviceUrl: "api/cronapi/crud/app.entity.Endereco", serviceUrlODATA: "/api/cronapi/odata/v2/app/Endereco" };
window.dataSourceMap["app.Formacao"] = { customId: "app.entity.Formacao", serviceUrl: "api/cronapi/crud/app.entity.Formacao", serviceUrlODATA: "/api/cronapi/odata/v2/app/Formacao" };
window.dataSourceMap["app.Tipoformacao"] = { customId: "app.entity.Tipoformacao", serviceUrl: "api/cronapi/crud/app.entity.Tipoformacao", serviceUrlODATA: "/api/cronapi/odata/v2/app/Tipoformacao" };
