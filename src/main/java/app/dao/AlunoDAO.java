...
public interface AlunoDAO extends JpaRepository<Aluno, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.tipoformacao FROM Formacao entity WHERE entity.aluno.id = :id")
  public Page<Tipoformacao> listTipoformacao(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM Formacao entity WHERE entity.aluno.id = :instanceId AND entity.tipoformacao.id = :relationId")
  public int deleteTipoformacao(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
